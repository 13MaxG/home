...
var jirandq = new Processing.Sketch();
jirandq.attachFunction = function(processing) {
	var width = 500;
	var height = 500;
	...
	processing.draw = function() 
	{
		...
		for(var arg = 0; arg <= 1.2; arg+=0.02)
		{
		for(var arg2 = 0; arg2 <= 1.2; arg2+=0.02)
		{
			...
			cur2.x = bezierX(points2, N, arg2) ;
			cur2.y = bezierY(points2, N, arg2);
			processing.strokeWeight(14);
			...
			processing.point(arg * width, arg2 * height);
